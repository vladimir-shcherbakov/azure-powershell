...
{
    public class EnableDiagnosticSettingCommandTests
    {
        private readonly EnableAzureRmDiagnosticSettingCommand cmdlet;
        ...
        public EnableDiagnosticSettingCommandTests(Xunit.Abstractions.ITestOutputHelper output)
        {
            ...
            this.cmdlet = new EnableAzureRmDiagnosticSettingCommand()
            {
